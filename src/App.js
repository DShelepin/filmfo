...
function App() {
  ...
  const randomMovie = useMemo(() => {
    return movies[movieList[getRandomMinMax(0, movieList.length - 1)].key][
    ...
    <div className=" min-h-screen ">
      ...
      >
        <div className="container mx-auto px-5 h-20 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div className=" text-xl font-bold text-orange-500">Filmfo</div>
          </div>
          <Input />
        </div>
      </header>
      ...
      >
        <div className=" container mx-auto px-5 pt-[30vh]">
          ...
          <button className=" h-12 px-5 bg-white mb-5 text-black rounded-md text-xl font-bold hover:bg-orange-500 hover:text-white transition-all duration-300">
            Details
          </button>
