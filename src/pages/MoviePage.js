  ...
  return (
    <>
          ...
          <div>
            ...
            {videoSrc ? (
              <button
                ...
                className=" h-12 px-5 bg-white mb-5 text-black rounded-md text-xl font-bold hover:bg-orange-500 hover:text-white transition-all duration-300"
              >
                Trailer
              </button>
            ) : null}
      ...
      >
        <div
          ref={ref}
          className=" fixed top-0 left-0 right-0 bottom-0 z-20 bg-black bg-opacity-80 flex justify-center items-center"
